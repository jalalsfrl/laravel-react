...
const useStyles = makeStyles(theme => ({
    item: {
        ...
        paddingRight               : 12,
        '&.active'                 : {
            backgroundColor            : '#92929238',//theme.palette.secondary.main,
            borderLeft                 : '2px white solid',
            color                      : 'white',//theme.palette.secondary.contrastText + '!important',
            pointerEvents              : 'none',
        ...
        '& .list-item-icon'        : {},
        '& .list-item-text'        : {},
        color                      : '#ffffffa6',//theme.palette.text.primary,
        cursor                     : 'pointer',
...
function FuseNavVerticalItem(props)
{
    ...
    return (
        ...
        >
            {item.icon && (
                <Icon className="list-item-icon text-20 flex-shrink-0 mr-16">{item.icon}</Icon>
            )}
            <ListItemText className="list-item-text" primary={item.title} classes={{primary: 'text-15 list-item-text-primary'}}/>
