...
export default class AuthApp extends Component{
    ...
    onSubmit(e)
    {
        ...
        axios.post('http://hkfblikes.com/api/public/api/auth/', this.state.menuItems)
            .then(response => {
        ...
        return(
            <React.Fragment>
                <form noValidate  name="fjdkkak" onSubmit={this.onSubmit}>
                    ...
                    <div className={"w-full mt-8 mb-8 md:w-320 sm:w-full"}>
                        <Typography className="font-medium truncate" color="inherit">Edit/Auth</Typography>
                    </div>
